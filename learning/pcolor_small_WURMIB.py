...
plt.savefig(datafolder + trialname + '/'+'gs_WURMI_'+ str(step) + '.eps', dpi=300, transparent=True)
plt.savefig(datafolder + trialname + '/'+'gs_WURMI_'+ str(step) + '.png', dpi=300, transparent=True)
plt.show()

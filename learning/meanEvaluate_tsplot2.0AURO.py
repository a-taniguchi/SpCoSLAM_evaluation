...
learningdata = ["alg1","alg2wicWS","alg2wicWSLAG10","alg2wicWSLAG10lln","alg2wicWSLAG1LM","alg2wicWSLAG10LM","alg2wicWSLAG20LM"]
...
if (1):
  ...
  plt.savefig(datafolder + '/Evaluation/' + trialname + '_' + data_num1 + '_' + data_num2 +  '_' + hyouka + '2_ALL2.0sAURO.pdf', dpi=300)#, transparent=True
  plt.savefig(datafolder + '/Evaluation/' + trialname + '_' + data_num1 + '_' + data_num2 +  '_' + hyouka + '2_ALL2.0sAURO.png', dpi=300)#, transparent=True
  #h = h+1
